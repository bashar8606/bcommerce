            ...
            <div className="flex">
              <Sheet>
                ...
                <SheetContent side={"left"} className="px-0 h-full pt-0">
                  ...
                  <div className="px-2.5 py-10 bg-gradient-to-br from-stone-200 to-amber-100 rounded-md justify-end items-start gap-[23px] inline-flex">
  <img className="w-[93px] absolute rounded-md shadow" src="https://via.placeholder.com/93x241" />
  <div className="relative w-[50%] ml-auto">
    <div className=" text-neutral-950 text-lg font-bold uppercase leading-[18px]">GRAB YOUR<br/>ITEM NOW</div>
    <div className=" text-orange-400 text-xs font-medium uppercase leading-3">SIGN UP/LOGIN</div>
  </div>
</div>
