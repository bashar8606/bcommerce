          ...
          <div className="">
            ...
            <div>
              <div className="flex items-end justify-between">
                ...
                {width >= 992 && (
                  <div>
                    <button className="text-black text-xs font-semibold inline-flex items-center " onClick={()=>moveToWishlist(data?.product_id, data?.id)}>
