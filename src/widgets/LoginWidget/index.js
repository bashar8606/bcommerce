                                                    ...
                                                    {!isOtpSent ? (
                                                        <div className="">
                                                            <div className="text-center mb-8">
                                                                ...
                                                                <p>Enter your registered phone number to access</p>
                                                            </div>
                                                            <div className="space-y-4">
                                                                ...
                                                                <button type="submit" className="btn btn-lg btn-primary w-full">Send OTP</button>
                                                                <button onClick={handleGoogleSignIn} className="btn btn-lg border w-full flex justify-center items-center">
